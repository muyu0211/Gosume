...
func (s *TemplateService) CloneTemplate(sourceID, newID string) error {
	...
	return util.UserWrap(s.tempRepo.Create(meta, src.CSS), "克隆模板失败")
}
