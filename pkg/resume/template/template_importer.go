...
// TemplatePackage 是本地 .zip 模板包经校验后的内容。
type TemplatePackage struct {
	Meta dto.TemplateMeta
	CSS  string
}
...
func LoadPackageFromZip(filePath string) (*TemplatePackage, error) {
...
func ValidatePackage(pkg *TemplatePackage) error {
	if pkg == nil {
...
func normalizeMeta(meta *dto.TemplateMeta) {
...
// 且纸张规格目前仅支持 A4。
func validateMeta(meta dto.TemplateMeta) error {
